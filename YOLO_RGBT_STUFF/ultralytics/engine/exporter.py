...
from YOLO_RGBT_STUFF.ultralytics.utils import ARM64, DEFAULT_CFG, IS_COLAB, IS_JETSON, LINUX, LOGGER, MACOS, PYTHON_VERSION, RKNN_CHIPS, ROOT, WINDOWS, __version__, colorstr, get_default_args, yaml_save
import numpy as np
import torch

from YOLO_RGBT_STUFF.ultralytics.cfg import TASK2DATA, get_cfg
from YOLO_RGBT_STUFF.ultralytics.data import build_dataloader
from YOLO_RGBT_STUFF.ultralytics.data.dataset import YOLODataset
from YOLO_RGBT_STUFF.ultralytics.data.utils import check_cls_dataset, check_det_dataset
from YOLO_RGBT_STUFF.ultralytics.nn.autobackend import check_class_names, default_class_names
from YOLO_RGBT_STUFF.ultralytics.nn.modules import C2f, Classify, Detect, RTDETRDecoder
from YOLO_RGBT_STUFF.ultralytics.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, WorldModel
from YOLO_RGBT_STUFF.ultralytics.utils import (
    callbacks,
)
from YOLO_RGBT_STUFF.ultralytics.utils.checks import (
    check_imgsz,
    check_is_path_safe,
    check_requirements,
    check_version,
...
from YOLO_RGBT_STUFF.ultralytics.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from YOLO_RGBT_STUFF.ultralytics.utils.files import file_size, spaces_in_path
from YOLO_RGBT_STUFF.ultralytics.utils.ops import Profile, nms_rotated, xywh2xyxy
from YOLO_RGBT_STUFF.ultralytics.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if imx:
            from YOLO_RGBT_STUFF.ultralytics.utils.torch_utils import FXModel
        ...
        for m in model.modules():
            ...
            if isinstance(m, Detect) and imx:
                from YOLO_RGBT_STUFF.ultralytics.utils.tal import make_anchors
