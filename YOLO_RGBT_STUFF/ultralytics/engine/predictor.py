...
from YOLO_RGBT_STUFF.ultralytics.utils import DEFAULT_CFG, LOGGER, MACOS, WINDOWS, colorstr, ops
import cv2
import numpy as np
import torch

from YOLO_RGBT_STUFF.ultralytics.cfg import get_cfg, get_save_dir
from YOLO_RGBT_STUFF.ultralytics.data import load_inference_source
from YOLO_RGBT_STUFF.ultralytics.data.augment import LetterBox, classify_transforms
from YOLO_RGBT_STUFF.ultralytics.nn.autobackend import AutoBackend
from YOLO_RGBT_STUFF.ultralytics.utils import callbacks
from YOLO_RGBT_STUFF.ultralytics.utils.checks import check_imgsz, check_imshow
from YOLO_RGBT_STUFF.ultralytics.utils.files import increment_path
from YOLO_RGBT_STUFF.ultralytics.utils.torch_utils import select_device, smart_inference_mode
import os
STREAM_WARNING = """
