...
import requests
from YOLO_RGBT_STUFF.ultralytics.utils import LOGGER, TQDM, clean_url, emojis, is_online, url2file
import torch
...
def attempt_download_asset(file, repo="ultralytics/assets", release="v8.3.0", **kwargs):
    ...
    Example:
        ...
        ```
    """
    from YOLO_RGBT_STUFF.ultralytics.utils import SETTINGS  # scoped for circular import
