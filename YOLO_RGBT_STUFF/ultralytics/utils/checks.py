...
from YOLO_RGBT_STUFF.ultralytics.utils import ARM64, ASSETS, AUTOINSTALL, IS_COLAB, IS_GIT_DIR, IS_KAGGLE, IS_PIP_PACKAGE, LINUX, LOGGER, MACOS, ONLINE, PYTHON_VERSION, RKNN_CHIPS, ROOT, TORCHVISION_VERSION, USER_CONFIG_DIR, WINDOWS, Retry, SimpleNamespace, ThreadingLocked, TryExcept, clean_url, colorstr, emojis, is_github_action_running, url2file
import cv2
import numpy as np
import requests
import torch
...
def collect_system_info():
    ...
    from YOLO_RGBT_STUFF.ultralytics.utils import ENVIRONMENT  # scope to avoid circular import
    from YOLO_RGBT_STUFF.ultralytics.utils.torch_utils import get_cpu_info, get_gpu_info
...
def check_amp(model):
    ...
    """
    from YOLO_RGBT_STUFF.ultralytics.utils.torch_utils import autocast
