...
from YOLO_RGBT_STUFF.ultralytics.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr
...
try:
    ...
    from YOLO_RGBT_STUFF.ultralytics.utils.torch_utils import de_parallel, torch
