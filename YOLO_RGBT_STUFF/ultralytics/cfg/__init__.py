...
from YOLO_RGBT_STUFF.ultralytics.utils import ASSETS, DEFAULT_CFG, DEFAULT_CFG_DICT, DEFAULT_CFG_PATH, DEFAULT_SOL_DICT, IS_VSCODE, LOGGER, RANK, ROOT, RUNS_DIR, SETTINGS, SETTINGS_FILE, TESTS_RUNNING, IterableSimpleNamespace, __version__, colorstr, deprecation_warn, vscode_msg, yaml_load, yaml_print
import cv2
...
def handle_yolo_hub(args: List[str]) -> None:
    ...
    """
    from YOLO_RGBT_STUFF.ultralytics import hub
...
def handle_yolo_solutions(args: List[str]) -> None:
    ...
    if s_n == "inference":
        ...
        from YOLO_RGBT_STUFF.ultralytics import solutions  # import ultralytics solutions
        ...
        from YOLO_RGBT_STUFF.ultralytics.utils.files import increment_path  # for output directory path update
...
def entrypoint(debug=""):
    ...
    if "rtdetr" in stem:  # guess architecture
        ...
        from YOLO_RGBT_STUFF.ultralytics import FastSAM

        model = FastSAM(model)
    elif "sam_" in stem or "sam2_" in stem or "sam2.1_" in stem:
        from YOLO_RGBT_STUFF.ultralytics import SAM
